...
export default function ListaFornecedoresScreen() {
  ...
  const [fornecedorParaDeletar, setFornecedorParaDeletar] = React.useState(null);
  ...
  return (
    <Box sx={{ padding: 3 }}>
      ...
      <Dialog open={dialogOpen} onClose={() => setDialogOpen(false)}>
        ...
        <DialogContent>
          <DialogContentText>
            Tem certeza que deseja deletar o fornecedor "{fornecedorParaDeletar?.nome}"? Esta ação não pode ser desfeita.
          </DialogContentText>
        </DialogContent>
        <DialogActions>
